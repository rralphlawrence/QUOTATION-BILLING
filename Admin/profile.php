               ...
               <body>
                    <main>
                        ...
                        <div class="modal-header">
                          ...
                          <button data-close-button class="close-button" style="border: none;  font-size: 1.7rem; cursor: pointer;">&times;</button>
                        </div>
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="form__div">
                                        <div class="control">
                                          <label for="" style="font-size:12px; color:grey;" > GENDER</label>
                                            <label class="radio">
                                    ...
                                    <input type="submit" class="form__button" name="update_billing_profile" value="SAVE">
                                </form>
                            </div>
                        </div>
                      </div>
