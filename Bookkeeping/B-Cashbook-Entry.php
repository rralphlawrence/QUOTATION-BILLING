    ...
    <body onload="setDataOnSelection()">
        <main>
            <section>
                    ...
                    <div class="box">
                        <div class="top">
                            ...
                            <button type="buttons" data-modal-target="#modal" class="buttonss" id="newData">
                                <span class="button__texts" >ADD</span>
                    ...
                    <div class="dropdown">
                        <form action="../includes/dbprocess.php" Method="POST">
                            ...
                            <span data-tooltip="SHOW RECORDS" >
                                <button style="background-color:#2860E1;" type="buttons" id="show" type="submit" name="show_table" class="buttonss">
                ...
                <!--MODAL-->
                <div class="modal" id="modal" style="height:400px">
                    <div class="modal-header">
                        <div class="title"></div>
                            <button data-close-button class="close-button">&times;</button>
                    </div>
                    <p style="text-align:center;"><img src="img/misoutlogo.png" alt="" class="LOGOS" style="width:80px;height:90px;"></p>    
    ...
    <!--TABLE-->
            <div id="overlay"></div>
                  <?php       
                         ...
                         $query = "SELECT cbe_id, cbe_date, cbe_order_by, cbe_description, cbe_inflows, cbe_outflows, cbe_balance FROM tblcashbookentry WHERE ((MONTH(cbe_date) = '$month' AND YEAR(cbe_date)= '$year')) Order By cbe_date, cbe_order_by ASC";    
                         $stmt = $conn->prepare($query);
                         $stmt-> execute();
                         $result = $stmt->get_result();  
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                ...
                <td data-label="Date"><?= $row['cbe_date'] ?></td>
                <td data-label="OD" hidden><?= $row['cbe_order_by'] ?></td>
                <td data-label="Description"><?= $row['cbe_description'] ?></td>
                <td data-label="Inflows"> <strong>₱ </strong><?= number_format($row['cbe_inflows']) ?></td>
                <td data-label="Outflows"><strong>₱ </strong><?= number_format($row['cbe_outflows']) ?></td>
                <td data-label="Balance"><strong>₱ </strong><?= number_format($row['cbe_balance']) ?></td>
            ...
            <div class="modal" id="modal2" style="height:440px">
                <div class="modal-header">
                    <div class="title"></div>
                        <button data-close-button class="close-button">&times;</button>
                </div>
                ...
                <form action="../includes/dbprocess.php" Method="POST" autocomplete="off"> 
                    <div id="Quarterly" class="hide" style="padding:1rem;">
                        <span class="custom-dropdown big">
                ...
                <form action="../includes/dbprocess.php" Method="POST" autocomplete="off">   
                    <div id="Yearly" class="hide" style="padding:1rem;">
                        <div class="input-container text">
                            <label for="text">Year</label>
