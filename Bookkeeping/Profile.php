...
?>
 <html>
               <body>
                    <main>
                        ...
                        <div class="modal-header">
                          ...
                          <button data-close-button class="P-close-button" style="border: none;  font-size: 1.7rem; cursor: pointer;">&times;</button>
                        </div>
                        
                        <div class="l-form">
                                <form action="../includes/dbprocess.php" class="form" Method="POST" enctype="multipart/form-data">

                        <div class="P-modal-logo">
                        ...
                        <div class="P-modal-body">
                                  ...
                                  <h4 style="margin:1px; color:grey;" ;>Profile info</h4>
                                    <div class="form__div">
                                    ...
                                    <h4 style="margin:0 0 10px 0; color:grey;" ;>Account info</h4>
                                    <div class="form__div">
                                    ...
                                    <input type="submit" class="form__button" name="update_bookkeeping_profile" value="SAVE">
                                </form>
                            </div>
                        </div>
                      </div>
      ...
      overlay.addEventListener('click', () => {
        const modals = document.querySelectorAll('.P-modal.active')
